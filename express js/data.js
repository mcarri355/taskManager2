...
const people = [
  { name: 'clean', desc: 'vacuum & sweep', id: 1 },
  { name: 'shop', desc: 'buy shorts', id: 2 },
  { name: 'cook', desc: 'make spahgetti', id: 3 },
  { name: 'pets', desc: 'feed turtle', id: 4 },
  { name: 'car', desc: 'get gas', id: 5 },
  { name: 'work', desc: 'finish report', id: 6 },
];
